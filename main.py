...
if __name__ == '__main__':
    ...
    myReactProjectName.grid(column=3, row=5, padx=10, pady=10,ipady=5)


    Label(screen1, text="Port Number : ",font=('Arial',15)).grid(column=2, row=6)
    ...
    Label(screen1, text="Enter Project Name : ",font=('Arial',15)).grid(column=2, row=19)

    myExpressProjectName = Entry(screen1,width=30,font=('Arial',15) )
    myExpressProjectName.insert(0, 'Ex. myDB')
    myExpressProjectName.grid(column=3, row=19, padx=10, pady=10,ipady=5)


    Label(screen1, text="Port Number : ",font=('Arial',15)).grid(column=2, row=20)
